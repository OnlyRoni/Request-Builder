                        ...
                        If Not Url.Text = "" Then
                            If Not PostData.Text = "" Then
                                If RequestLIB.SelectedItem = "Normal" Then
                                    Dim PostDataFix As String = PostData.Text.Replace(My.Resources.StringAP, My.Resources.StringFix1)
                                ...
                                ElseIf RequestLIB.SelectedItem = "WebClient" Then
                                    Dim PostDataFix As String = PostData.Text.Replace(My.Resources.StringAP, My.Resources.StringFix1)
                                    Dim FirstLine As String = $"Resp = {My.Resources.StringAP}{My.Resources.StringAP}"
...
#Region "C# POST Request"
                    ElseIf LanguageChoose.SelectedItem = "C#" Then
                        If Not Url.Text = "" Then
                            If RequestLIB.SelectedItem = "Normal" Then
                                Dim PostDataFix As String = PostData.Text.Replace(My.Resources.StringAP, My.Resources.StringFix2)
                                Dim FirstLine As String = $"string Resp = {My.Resources.StringAP}{My.Resources.StringAP};"
...
#Region "VB.NET GET Request"
                    If LanguageChoose.SelectedItem = "Visual Basic" Then
                        If Not Url.Text = "" Then
                            ...
                            ElseIf RequestLIB.SelectedItem = "WebClient" Then
                                Dim Firsty As String = $"Resp = {My.Resources.StringAP}{My.Resources.StringAP}"
